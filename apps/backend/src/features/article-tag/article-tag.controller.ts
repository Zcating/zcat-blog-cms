...
export class ArticleTagController {
  ...
  async findAll(): Promise<ResultData<ArticleTag[]>> {
    try {
      ...
      const tags = await this.articleTagService.findAll();
  ...
  async findOne(
    ...
    try {
      ...
      const tag = await this.articleTagService.findOne(id);
  ...
  async create(
    ...
    try {
      ...
      const tag = await this.articleTagService.create(createArticleTagDto);
  ...
  async update(
    ...
    try {
      ...
      const result = await this.articleTagService.update(
        id,
        updateArticleTagDto,
      );
